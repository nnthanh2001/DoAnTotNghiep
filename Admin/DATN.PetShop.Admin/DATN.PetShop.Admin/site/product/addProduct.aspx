                        ...
                        <div class="card-body">
                            <div margin="text-align: left">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <%-- <div class="mb-3 row">
                                        <label for="example-tel-input" class="col-sm-2 col-form-label text-end">Mô tả</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" rows="3" id="example-text-input"></textarea>
                                        </div>
                                    </div>--%>
                                    <div class="mb-3 row">
                                        <label class="col-sm-2 col-form-label text-end">Giá nhập</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" type="number" value="35.000" id="">
                                        </div>
                                        <label class="col-sm-2 col-form-label text-end">Giá bán</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" type="number" value="40.000" id="">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
