...
namespace Entities.Route
{
    public class Routed
    {
        public static async void Register(RouteCollection routes)
        {
            ...
            routes.MapPageRoute("addProduct", "san-pham/them-moi-san-pham", "~/site/product/addProduct.aspx", false);
            ...
            routes.MapPageRoute("addUser", "nhan-vien/them-moi-nhan-vien", "~/site/user/addUser.aspx", false);
