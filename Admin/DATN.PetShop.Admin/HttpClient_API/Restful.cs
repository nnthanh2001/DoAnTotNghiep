...
//        public async Task<TEntity> Delete<TEntity>(string baseUrl, string apiUrl)
//        {
//            var response = new ResponseModel<TEntity> { HttpStatusCode = 404 };
//            if (baseUrl != null && baseUrl != "")
//            {
//                if (apiUrl != null && apiUrl != "")
//                {
...
//                        var request = client.DeleteAsync(apiUrl, cancellationTokenSource.Token);
//                        if (request.Status == TaskStatus.WaitingForActivation)
//                        {
//                            Thread.Sleep(500);
//                        }
...
//        #region Reful by No Response Model: 2022-05-06
